...
def build_model(model_args, model_type, fields, device, predict=False):
    encoder = build_encoder(model_type, model_args, fields, device)
    decoder = build_decoder(model_type, model_args, fields, device)
