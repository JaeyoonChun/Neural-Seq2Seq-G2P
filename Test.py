...
def test(dataset, model, device):
    # TODO 모델 인자
    model.load_state_dict(torch.load('checkpoints/2020-08-17T11:04:29/model_best.pt'))
    ...
    for batch in tqdm(test_iter):
        ...
        gra = batch.grapheme.squeeze(1).data.tolist()[1:-1]
        pho = batch.phoneme.squeeze(1).data.tolist()[1:-1]
    ...
    with open('checkpoints/2020-08-17T11:04:29/test_out.json', 'w', encoding='utf-8') as wf:
        json.dump(out, wf, ensure_ascii=False, indent='\t')


if __name__ == "__main__":
    input_file = 'checkpoints/2020-08-17T11:04:29/test_out.json'
